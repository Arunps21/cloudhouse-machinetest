...
// Utility functions
export const getStatusByValue = (value) => projectStatuses.find(s => s.value === value);
export const getTaskStatusByValue = (value) => taskStatuses.find(s => s.value === value);
export const getPriorityByValue = (value) => priorities.find(p => p.value === value);
