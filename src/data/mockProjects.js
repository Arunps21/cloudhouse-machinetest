...
export const mockProjects = [
  {
    ...
    description:
      "Complete redesign of the customer-facing e-commerce platform with modern UI/UX, improved performance, and mobile-first approach. This project includes revamping the product catalog, checkout flow, and user account management.",
    status: "in-progress",
    priority: "high",
    ...
    tasks: [
      ...
      },
      {
        ...
        description:
          "Develop RESTful API endpoints for product catalog management",
        status: "done",
        assignee: "u4",
      ...
      },
      {
        ...
        description:
          "Implement shopping cart functionality with persistent storage",
        status: "in-progress",
        assignee: "u2",
      ...
      },
      {
        ...
        description:
          "Implement OAuth2 authentication with social login options",
        status: "todo",
        assignee: "u2",
      ...
      },
      {
        ...
        description:
          "Comprehensive testing across all mobile devices and browsers",
        status: "todo",
        assignee: "u5",
        createdAt: "2026-01-15",
      },
  ...
  },
  {
    ...
    description:
      "Develop a cross-platform mobile application using React Native for iOS and Android. The app will provide customers with a seamless shopping experience on mobile devices.",
    status: "planned",
    priority: "high",
    ...
    tasks: [
      {
        ...
        description:
          "Set up React Native project with proper folder structure and CI/CD",
        status: "todo",
        assignee: "u2",
        createdAt: "2026-01-15",
      },
  ...
  },
  {
    ...
    description:
      "Build a comprehensive analytics dashboard for business intelligence. Features include real-time data visualization, custom report generation, and predictive analytics capabilities.",
    status: "in-progress",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Develop an integrated customer support portal with ticketing system, live chat, and knowledge base. Aims to improve customer satisfaction and reduce support response times.",
    status: "completed",
    priority: "medium",
  ...
  },
  {
    ...
    description:
      "Migrate existing on-premise infrastructure to AWS cloud. Includes server migration, database optimization, and implementing auto-scaling capabilities.",
    status: "on-hold",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Comprehensive security audit of all systems and implementation of compliance requirements for SOC 2 and GDPR certification.",
    status: "in-progress",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Refresh the company marketing website with updated branding, improved SEO, and better lead generation capabilities.",
    status: "planned",
    priority: "low",
  ...
  },
  {
    ...
    description:
      "Implement a centralized API gateway for microservices architecture. Includes rate limiting, authentication, and request routing.",
    status: "completed",
    priority: "medium",
